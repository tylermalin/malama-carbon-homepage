-- Create user_invites table for tracking admin invitations
-- This allows admins to invite new users to the platform
...
COMMENT ON TABLE public.user_invites IS 'Tracks user invitations sent by admins';
COMMENT ON COLUMN public.user_invites.status IS 'pending | accepted | expired';

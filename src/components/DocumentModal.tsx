  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 w-[92vw] max-w-3xl -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-4 shadow-2xl" style={{ zIndex: 9999 }}>

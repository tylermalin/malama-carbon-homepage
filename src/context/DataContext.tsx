...
import type { Citation, KPI, Series, MarketData } from "../types/market";

const DataContext = createContext<MarketData | null>(null);

export function DataProvider({ children }: { children: ReactNode }) {
  // Minimal illustrative defaults; replace with live data loader or prop injection.
  const value = useMemo<MarketData>(() => ({
    ...
    kpis: [
      ...
      { key:"issuance_q2_2025", label:"Issuance Q2 2025", value:"77M", note:"Illustrative" },
      { key:"unique_buyers", label:"Unique Buyers (lifetime)", value:"17,600+", note:"AlliedOffsets (illustrative)" },
      { key:"avg_eua", label:"EU Allowance (illustrative)", value:"€80" }
    ],
    series: [
      {
        key:"eu_ets_price",
